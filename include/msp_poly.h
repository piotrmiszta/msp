...
//Roots
msp_vector* msp_poly_real_roots(msp_poly* poly);
msp_vector_complex* msp_poly_roots(msp_poly* poly);
msp_poly* msp_poly_horner(msp_poly* poly, double denom);
msp_poly* msp_poly_div_2(msp_poly* poly, double b, double c);
